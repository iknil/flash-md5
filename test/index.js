(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.MD5Tool = factory());
    ...
    ***************************************************************************** */
    ...
    (function (ACTION_TYPE) {
        ...
        ACTION_TYPE[ACTION_TYPE["end"] = 1004] = "end";
        ACTION_TYPE[ACTION_TYPE["STATE"] = 1005] = "STATE";
        ACTION_TYPE[ACTION_TYPE["RESTORE"] = 1006] = "RESTORE";
    ...
    var MD5Tool = /** @class */ (function () {
            ...
            this.handler = {
                start: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                (_a = this.worker) === null || _a === void 0 ? void 0 : _a.postMessage([1002]);
                ...
                update: function (chuck) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                (_a = this.worker) === null || _a === void 0 ? void 0 : _a.postMessage([1003, this.getU8ABFromAB(chuck)]);
                                return [4 /*yield*/, this.actionDone(CALLBACK_TYPE.OTHERS)];
                            case 1:
                                _b.sent();
                                return [2 /*return*/];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                (_a = this.worker) === null || _a === void 0 ? void 0 : _a.postMessage([1004]);
                                return [4 /*yield*/, this.actionDone(CALLBACK_TYPE.OTHERS)];
                            case 1: return [2 /*return*/, _b.sent()];
                        }
                    });
                }); },
                state: function () { return __awaiter(_this, void 0, void 0, function () {
                    var result;
                    var _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                (_a = this.worker) === null || _a === void 0 ? void 0 : _a.postMessage([1005]);
                                return [4 /*yield*/, this.actionDone(CALLBACK_TYPE.OTHERS)];
                            case 1:
                                result = _b.sent();
                ...
                restore: function (state) { return __awaiter(_this, void 0, void 0, function () {
                    var _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                (_a = this.worker) === null || _a === void 0 ? void 0 : _a.postMessage([1006, state]);
                                return [4 /*yield*/, this.actionDone(CALLBACK_TYPE.OTHERS)];
                            case 1:
                                _b.sent();
                                return [2 /*return*/];
        ...
        MD5Tool.prototype.state = function () {
            return __awaiter(this, void 0, Promise, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.handler.state()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        MD5Tool.prototype.restore = function (chuck) {
            return __awaiter(this, void 0, Promise, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.handler.restore(chuck)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this];
                    }
